...
export default function queryPage() {
    ...
    const onClickHandler = () => {
        ...
        if(sinceVal !== "") qs.append("since", dayjs().subtract(parseInt(sinceVal), "seconds").unix().toString());
        ...
        <div className="flex justify-center items-center">
            <div className="border border-rounded p-4 mt-24">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-2">Lookup a package by name, version, or the time it was scanned</p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                    ...
                    <div className="space-y-2">
                        <Label className="font-bold" htmlFor="version">Version</Label>
                        <Input id="version" value={version} onChange={(e) => setVersion(e.target.value)} disabled={name === ""}/>
                    </div>
                    <div className="space-y-2">
                        <Label className="font-bold" htmlFor="since">Since</Label>
